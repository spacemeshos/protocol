...
0. Pre round: each participant shares their current view of fully valid blocks.
1. Status round: each participant broadcasts a status message reporting its current accepted set.
2. Proposal round: a leader is randomly chosen, and broadcasts a proposal to the group. Each participant that receives and accepts this proposal broadcasts a message to this effect.
